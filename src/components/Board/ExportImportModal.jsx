...
import { VscClose, VscCloudDownload, VscCloudUpload, VscFile } from 'react-icons/vsc';
import {
    ...
    <div style={{
      ...
      >
        ...
        <div style={sectionStyle}>
          <div style={headingStyle}><VscCloudDownload /> EXPORT</div>
          ...
          <button style={primaryBtn} onClick={handleExport}>
            <VscCloudDownload /> Download {format.toUpperCase()}
          </button>
        </div>

        {/* Import */}
        <div style={sectionStyle}>
          <div style={headingStyle}><VscCloudUpload /> IMPORT</div>
          {!importPreview ? (
            <>
